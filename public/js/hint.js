window.hint = [
    ...
    },
    {
        theme: 'room1',
        hintNumber: '5',
        hintContent: '파일 안 남자의 사진과 피난안내도를 비교하여 사진을 시간 순서대로 보고, 파일에서 남자가 서있는 위치를 확인하고 피난 안내도 속 남자의 위치를 비추는 CCTV 그림을 확인해주세요. 이때 피난 안내도 속 노란 불빛은 정답과는 무관라니 CCTV 모양 자체만 봐주세요. 이 방식으로, 사진 5장 속 남자의 위치를 비추는 CCTV를 확인한 뒤, 사진 순서대로 이동경로를 방향 자물쇠에 입력해주세요.'
    },
    {
        theme: 'room1',
        hintNumber: '6',
