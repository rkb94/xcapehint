window.hint = [
    ...
    },
    {
        theme: 'room1',
        hintNumber: '5',
        hintContent: '파일 안 남자의 사진과 피난안내도를 함께 보고 피난 안내도를 기준으로 남자가 어느 방향으로 이동하는지 손가락으로 따라가며 확인해주세요[ _ _ _ _ ]'
    },
    {
        theme: 'room1',
        hintNumber: '6',
    ...
    ///////// 기묘한 날개짓 /////////
    {
        theme: 'room2',
        hintNumber: '1',
        hintContent: '책상 위 남자얼굴 그림이 그려진 잡지 속 마크를 태깅해서 기사 내용 속 보름 전 사건이라는 사실을 확인 후, 잡지 위 날짜에서 보름을 빼주세요 + 캐비넷 왼쪽 편 기사 속 마크를 태깅 하고, 기사 내용 속 이틀 전 사건이라는 사실을 확인 후 태깅 내용 속 날짜에서 이틀을 빼주세요. 일만 붙여서 캐비넷에 입력해주세요. [ _ _ _ _ ]'
    },
    {
        theme: 'room2',
        hintNumber: '2',
